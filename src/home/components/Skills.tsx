        ...
        <div id="skills">
            <div>
                <p className="text-lg mb-2">
                    Some of my frequently used languages are
                </p>
                <ul>
            ...
            <div>
                <p className="text-lg mb-2">
                    I am also proficient in the following web technologies
                </p>
                <ul>
            ...
            <div>
                <p className="text-lg mb-2">
                    My projects in Machine Learning and Data Analysis make use
                    of the following
                </p>
                <ul>
            ...
            <div>
                <p>
                    Additionally, many projects that I work on utilize version
                    control with Git and virtualization using technologies such
                    as Docker
                </p>
            </div>
        </div>
